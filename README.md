# AXD — Agent Experience Design

How to design websites and web apps for AI agents.

UX is how you design for humans. AXD is how you design for agents.

---

## What is AXD?

Agents are the new users. They browse your site, call your API, read your docs, and complete tasks on behalf of humans. Most websites are designed exclusively for human eyes and human hands. AXD is the practice of designing your web presence so agents can use it too.
...
Install the [AXD audit skill](skill/SKILL.md) to evaluate any website against these principles.
...
└── site/              # Website (separate repo for deployment)
```
...
*An open standard by [souls.zip](https://souls.zip).*
